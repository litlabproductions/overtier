...
public class BrigitteFrag extends Fragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        TextView abitityTV11 = (TextView) getActivity().findViewById(R.id.ability_textview_50);
        TextView abitityTV12 = (TextView) getActivity().findViewById(R.id.ability_textview_51);
        TextView abitityTV13 = (TextView) getActivity().findViewById(R.id.ability_textview_20);
        TextView abitityTV14 = (TextView) getActivity().findViewById(R.id.ability_textview_21);
        ...
        abitityTV13.setTypeface(typeface);
        abitityTV14.setTypeface(typeface);
        ...
        patchNotesBtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                if (act instanceof MainActivity)      // change ********
                    ((MainActivity) act).getSoundPool().play(((MainActivity) act).getSoundBrigitte2(), 1, 1, 0, 0, 1);
                fragment = new BrigittePatchFrag();
                ft = getActivity().getSupportFragmentManager().beginTransaction();
                ft.setCustomAnimations(R.anim.enter_from_left, R.anim.exit_to_right);
                ft.addToBackStack("brigitte");
    ...
    {
       View view = inflater.inflate(R.layout.frag_brigitte,container, false);
       return view;
    }
}