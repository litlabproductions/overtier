...
public class DoomfistFrag extends Fragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        patchNotesBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (act instanceof MainActivity)
                    ((MainActivity) act).getSoundPool().play(((MainActivity) act).getSoundDoomfist2(), 1, 1, 0, 0, 1);
                fragment = new DoomfistPatchFrag();
                ft = getActivity().getSupportFragmentManager().beginTransaction();
                ft.setCustomAnimations(R.anim.enter_from_top, R.anim.exit_to_right);
                ft.addToBackStack("doomfist");
    ...
    {
       View view = inflater.inflate(R.layout.frag_doomfist,container, false);
        return view;
    }
}