...
public class JunkratFrag extends Fragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        patchNotesBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (act instanceof MainActivity)
                    ((MainActivity) act).getSoundPool().play(((MainActivity) act).getSoundJunkrat2(), 1, 1, 0, 0, 1);
                fragment = new JunkratPatchFrag();
                ft = getActivity().getSupportFragmentManager().beginTransaction();
                ft.setCustomAnimations(R.anim.enter_from_left, R.anim.exit_to_right);
                ft.addToBackStack("junkrat");
    ...
    {
       View view = inflater.inflate(R.layout.frag_junkrat, container, false);
        return view;
    }
}