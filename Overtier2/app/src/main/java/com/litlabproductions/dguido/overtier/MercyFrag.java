...
public class MercyFrag extends Fragment
{
 ...
 */
        ...
        patchNotesBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (act instanceof MainActivity)
                    ((MainActivity) act).getSoundPool().play(((MainActivity) act).getSoundMercy2(), 1, 1, 0, 0, 1);
                fragment = new MercyPatchFrag();
                ft = getActivity().getSupportFragmentManager().beginTransaction();
                ft.setCustomAnimations(R.anim.enter_from_left, R.anim.exit_to_right);
                ft.addToBackStack("mercy");
    ...
    {
       View view = inflater.inflate(R.layout.frag_mercy, container, false);
        return view;
    }
}