...
public class MoiraFrag extends Fragment
{
        ...
        patchNotesBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (act instanceof MainActivity)      // change ********
                    ((MainActivity) act).getSoundPool().play(((MainActivity) act).getSoundMoira2(), 1, 1, 0, 0, 1);
                fragment = new MoiraPatchFrag();
                ft = getActivity().getSupportFragmentManager().beginTransaction();
                ft.setCustomAnimations(R.anim.enter_from_left, R.anim.exit_to_right);
                ft.addToBackStack("moira");
    ...
    {
       View view = inflater.inflate(R.layout.frag_moira,container, false);
        return view;
    }
}