...
public class OrisaFrag extends Fragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        patchNotesBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (act instanceof MainActivity)
                    ((MainActivity) act).getSoundPool().play(((MainActivity) act).getSoundOrisa2(), 1, 1, 0, 0, 1);
    ...
    {
       View view = inflater.inflate(R.layout.frag_orisa, container, false);
        return view;
    }
}