...
public class ReinFrag extends Fragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        patchNotesBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                fragment = new ReinPatchFrag();
                ft = getActivity().getSupportFragmentManager().beginTransaction();
                ft.setCustomAnimations(R.anim.enter_from_left, R.anim.exit_to_right);
                ft.addToBackStack("rein");
    ...
    {
       View view = inflater.inflate(R.layout.frag_rein, container, false);
        return view;
    }
}