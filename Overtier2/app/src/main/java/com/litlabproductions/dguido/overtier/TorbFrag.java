...
public class TorbFrag extends Fragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        TextView abitityTV13 = (TextView) getActivity().findViewById(R.id.ability_textview_13);
        TextView abitityTV14 = (TextView) getActivity().findViewById(R.id.ability_textview_14);
        ...
        patchNotesBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (act instanceof MainActivity)
                    ((MainActivity) act).getSoundPool().play(((MainActivity) act).getSoundTorb2(), 1, 1, 0, 0, 1);
                fragment = new TorbPatchFrag();
                ft = getActivity().getSupportFragmentManager().beginTransaction();
                ft.setCustomAnimations(R.anim.enter_from_left, R.anim.exit_to_right);
                ft.addToBackStack("torb");
    ...
    {
       View view = inflater.inflate(R.layout.frag_torb,container, false);
        return view;
    }
}