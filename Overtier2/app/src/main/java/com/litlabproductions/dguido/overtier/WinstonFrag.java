...
public class WinstonFrag extends Fragment
{
...
public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
{
    ...
    patchNotesBtn.setOnClickListener(new View.OnClickListener(){
        ...
        public void onClick(View v) {
            if (act instanceof MainActivity)
                ((MainActivity) act).getSoundPool().play(((MainActivity) act).getSoundWinston2(), 1, 1, 0, 0, 1);
            fragment = new WinstonPatchFrag();
            ft = getActivity().getSupportFragmentManager().beginTransaction();
            ft.setCustomAnimations(R.anim.enter_from_left, R.anim.exit_to_right);
            ft.addToBackStack("winston");
    ...
    {
        View view = inflater.inflate(R.layout.frag_winston, container, false);
        return view;
    }
}